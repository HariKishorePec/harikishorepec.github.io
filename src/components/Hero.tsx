        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <img src={profileImage} alt="Hari Kishore - Software Development Engineer" className="relative w-40 h-40 md:w-48 md:h-48 rounded-full object-cover border-4 border-primary shadow-glow" />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center items-center pt-4">
            ...
            <Button size="lg" variant="outline" className="border-primary/50" onClick={() => window.open("https://github.com/harikishorepec", "_blank")}>
              <Github className="mr-2 h-5 w-5" />
              GitHub
            </Button>
            <Button size="lg" variant="outline" className="border-primary/50" onClick={() => window.open("https://www.linkedin.com/in/hari-kishore-pec/", "_blank")}>
